function cargarExamenes(){
	 ...
	 $.ajax({
		  method: "POST",
		  url: "/orden/examenes?orden_id="+orden_id,
...
function cargarPlantillaExamen(examen_id){
	 ...
	 $.ajax({
		  method: "POST",
		  url: "/orden/examen-plantilla?examen_id="+examen_id,
...
function plantillaPruebaSensibilida(germen_id){
	 $.ajax({
		  method: "POST",
		  url: "/orden/prueba-sensibilidad-examen-germen?examen_germen_id="+germen_id,
...
function guardarPruebaSensiblidad(germen_id){
	 ...
	 $.ajax({
		  method: "POST",
		  url: "/orden/guardar-prueba-sensiblidad",
