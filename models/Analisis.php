...
class Analisis extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tipo_muestra_id'], 'exist', 'skipOnError' => true, 'targetClass' => TipoMuestra::className(), 'targetAttribute' => ['tipo_muestra_id' => 'id']],
            [['tipo_analisis_id'], 'exist', 'skipOnError' => true, 'targetClass' => TipoAnalisis::className(), 'targetAttribute' => ['tipo_analisis_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(TipoMuestra::className(), ['id' => 'tipo_muestra_id']);
    }
    ...
    {
        return $this->hasOne(TipoAnalisis::className(), ['id' => 'tipo_analisis_id']);
    }
    ...
    {
        return $this->hasMany(CotizacionAnalisis::className(), ['analisis_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Examen::className(), ['analisis_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Parametro::className(), ['analisis_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Parametro::className(), [ 'analisis_id' => 'id' ])->orderBy([ 'seccion_id' => SORT_ASC, 'orden_impresion' => SORT_ASC, 'id'=> SORT_ASC ]);
    }
    ...
    {
        return $this->hasMany(Seccion::className(), ['analisis_id' => 'id']);
    }
