...
class ExamenParametro extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['parametro_id'], 'exist', 'skipOnError' => true, 'targetClass' => Parametro::className(), 'targetAttribute' => ['parametro_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Parametro::className(), ['id' => 'parametro_id']);
    }
}
