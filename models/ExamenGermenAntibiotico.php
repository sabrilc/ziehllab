...
/**
    ...
    public function rules()
    {
        return [
            ...
            [['valor'], 'string', 'max' => 8],
            [['tipo'], 'string', 'max' => 15],
            [['antibiotico_id'], 'exist', 'skipOnError' => true, 'targetClass' => Antibiotico::className(), 'targetAttribute' => ['antibiotico_id' => 'id']],
            [['examen_germen_id'], 'exist', 'skipOnError' => true, 'targetClass' => ExamenGermen::className(), 'targetAttribute' => ['examen_germen_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Antibiotico::className(), ['id' => 'antibiotico_id']);
    }
    ...
    {
        return $this->hasOne(ExamenGermen::className(), ['id' => 'examen_germen_id']);
    }
}
