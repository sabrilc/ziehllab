 ...
 */
class DocenteSearch extends User
{
   public $_id_paralelo; 
   /**
     * {@inheritdoc}
    ...
    public function rules()
    {
        return [
            [['id', ], 'integer'],
            [['username', 'email', 'auth_key', 'created_at', 'updated_at', 'password', 'nombres', 'primer_apellido', 'segundo_apellido', 'identificacion', 'foto'], 'safe'],
        ];
    }
