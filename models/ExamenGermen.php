   ...
   public $_id;
    ...
    public function rules()
    {
        return [
            ...
            [['germen_id'], 'exist', 'skipOnError' => true, 'targetClass' => Germen::className(), 'targetAttribute' => ['germen_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Germen::className(), ['id' => 'germen_id']);
    }
    ...
    {
        return $this->hasMany(ExamenGermenAntibiotico::className(), ['examen_germen_id' => 'id']);
    }
