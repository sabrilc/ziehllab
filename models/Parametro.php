...
class Parametro extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['metodo_id'], 'exist', 'skipOnError' => true, 'targetClass' => Metodo::className(), 'targetAttribute' => ['metodo_id' => 'id']],
            [['medida_id'], 'exist', 'skipOnError' => true, 'targetClass' => Medida::className(), 'targetAttribute' => ['medida_id' => 'id']],
    ...
    {
        return $this->hasMany(ExamenParametro::className(), ['parametro_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(Metodo::className(), ['id' => 'metodo_id']);
    }
    ...
    {
        return $this->hasOne(Medida::className(), ['id' => 'medida_id']);
    }
