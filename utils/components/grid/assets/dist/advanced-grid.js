SelectColumn = {
    'init': function() {    	
        var that = this;
        jQuery('body').on('change', 'select[data-action="select-column"]', function () {
        	  var $this = jQuery(this);
        	  that.saveValue($this);
        	//  $.pjax.reload({container:'#facturaDetalle'});
    ...
    'init': function() {
        ...
        jQuery('body').on('focus', 'input[data-action="input-column"]', function () {
            ...
            if (e.keyCode == 27) {
                ...
                that.saveValue($this);
               // $.pjax.reload({container:'#facturaDetalle'});
          	   // $.pjax.reload({container:'#facturaTotal'});
           ...
           // $.pjax.reload({container:'#facturaDetalle'});
           // $.pjax.reload({container:'#'+$input.data('pajaxContainer')});
