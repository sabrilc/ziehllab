...
echo Nav::widget([
    'items' => [
        ...
        [
            'label' => 'Informes',
            'items' => [              
                        ['label' => '<i class="mdi mdi-file-chart"></i><span class="nav-text">Informe</span>','encode' => false, 'url' => ['/orden/informe'],'visible'=> \Yii::$app->user->can('administrador')],
                        ['label' => '<i class="mdi mdi-cloud-download"></i><span class="nav-text">Descarga Ordenes</span>','encode' => false, 'url' => ['/orden/descarga'],'visible'=> \Yii::$app->user->can('administrador')],
                       ],
