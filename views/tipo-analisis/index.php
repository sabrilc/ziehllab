...
/* @var $searchModel app\models\TipoAnalisisSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tipo Análisis';
...
<div class="tipo-analisis-index">
    ...
    <p>
        <?= Html::a('Nuevo Tipo Análisis', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
                        ...
                        Html::a('<span> <b class="mdi mdi-circle-edit-outline"></b></span> ',
                            ...
                            Html::a('<span> <b class="mdi mdi-eye-outline"></b></span> ',
                                ...
                                Html::a('<span> <b class="mdi mdi-trash-can-outline"></b></span> ',
                                    \yii\helpers\Url::to(['tipo-analisis/delete','id' => $model->id]),
                                    ['class'=>'btn btn-primary','title' => Yii::t('yii', 'Borrar'),'aria-label' => Yii::t('yii', 'Borrar'),
                                        'data-confirm' => Yii::t('yii', 'Esta seguro de eliminar el tipo de analisis ?'),
                                        'data-method'  => 'post',
                                    ]).
                                    '</div>';
                    }
