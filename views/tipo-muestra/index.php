...
/* @var $searchModel app\models\TipoMuestraSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tipo de Muestras';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tipo-muestra-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Nuevo Tipo de Muestra', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
                        ...
                        Html::a('<span> <b class="mdi mdi-circle-edit-outline"></b></span> ',
                            ...
                            Html::a('<span> <b class="mdi mdi-eye-outline"></b></span> ',
                                ...
                                Html::a('<span> <b class="mdi mdi-trash-can-outline"></b></span> ',
                                    \yii\helpers\Url::to(['tipo-muestra/delete','id' => $model->id]),
